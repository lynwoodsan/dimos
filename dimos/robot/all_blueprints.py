...
all_modules = {
    "arise-sim-adapter": "dimos.navigation.smartnav.modules.arise_sim_adapter.AriseSimAdapter",
    "arise-slam": "dimos.navigation.smartnav.modules.arise_slam.arise_slam.AriseSLAM",
    ...
    "click-to-goal": "dimos.navigation.smartnav.modules.click_to_goal.click_to_goal.ClickToGoal",
    "cmd-vel-mux": "dimos.navigation.smartnav.modules.cmd_vel_mux.CmdVelMux",
    ...
    "far-planner": "dimos.navigation.smartnav.modules.far_planner.far_planner.FarPlanner",
    ...
    "local-planner": "dimos.navigation.smartnav.modules.local_planner.local_planner.LocalPlanner",
    ...
    "odom-adapter": "dimos.navigation.smartnav.modules.odom_adapter.odom_adapter.OdomAdapter",
    "osm-skill": "dimos.agents.skills.osm.OsmSkill",
    "path-follower": "dimos.navigation.smartnav.modules.path_follower.path_follower.PathFollower",
    ...
    "pgo": "dimos.navigation.smartnav.modules.pgo.pgo.PGO",
    ...
    "ros-nav": "dimos.navigation.rosnav_legacy.ROSNav",
    "sensor-scan-generation": "dimos.navigation.smartnav.modules.sensor_scan_generation.sensor_scan_generation.SensorScanGeneration",
    ...
    "tare-planner": "dimos.navigation.smartnav.modules.tare_planner.tare_planner.TarePlanner",
    "temporal-memory": "dimos.perception.experimental.temporal_memory.temporal_memory.TemporalMemory",
    "terrain-analysis": "dimos.navigation.smartnav.modules.terrain_analysis.terrain_analysis.TerrainAnalysis",
    "terrain-map-ext": "dimos.navigation.smartnav.modules.terrain_map_ext.terrain_map_ext.TerrainMapExt",
    "tui-control-module": "dimos.navigation.smartnav.modules.tui_control.tui_control.TUIControlModule",
